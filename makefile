...
SRC  = $(SRC1) $(SRC2)
#
OBJ1 = build/build$(OBJ) build/driver$(OBJ) build/bm_utils$(OBJ) build/rnd$(OBJ) build/print$(OBJ) \
	build/load_stub$(OBJ) build/bcd2$(OBJ) build/speed_seed$(OBJ) build/text$(OBJ) build/permute$(OBJ) \
	build/rng64$(OBJ)
OBJ2 = build/build$(OBJ) build/bm_utils$(OBJ) build/qgen$(OBJ) build/rnd$(OBJ) build/varsub$(OBJ) \
	build/text$(OBJ) build/bcd2$(OBJ) build/permute$(OBJ) build/speed_seed$(OBJ) build/rng64$(OBJ)
OBJS = $(OBJ1) $(OBJ2)
#
build/%.o: %.c
	$(CC) $(CFLAGS) -c -o $@ $<
